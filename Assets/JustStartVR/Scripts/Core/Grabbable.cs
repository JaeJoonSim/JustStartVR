...
namespace JustStartVR {
    ...
    public class Grabbable : MonoBehaviour {
        ...
        /// <summary>
        /// If a PlayerController is provided we can check for player movements and make certain adjustments to physics.
        /// </summary>
        ...
        /// <summary>
        /// A PlayerController is optional, but if one is available we can check the last moved time in order to strengthen the physics joint during quick movements. This helps prevent jitter or flying objects in certain situations.
        /// </summary>
        /// <returns></returns>
