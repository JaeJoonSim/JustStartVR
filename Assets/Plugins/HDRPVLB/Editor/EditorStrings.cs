...
namespace HDRPVLB
{
    public static class EditorStrings
    {
        ...
        public static class Beam
        {
            ...
            public const string PrefEditInScene = "HDRPVLB_BEAM_EDITINSCENE";
            public const string PrefShowAddClippingPlane = "HDRPVLB_BEAM_SHOWADDCLIPPINGPLANE";
        }
        ...
        public static class DynOcclusion
        {
            ...
            public static string HelpLayerMaskIssues { get { return string.Format("The beams are generated on the layer '{0}' (set in the Config), but this LayerMask includes this layer.\nTo keep good performance, it's highly recommended to set a LayerMask which doesn't include this layer!", UnityEngine.LayerMask.LayerToName(HDRPVLB.Config.Instance.geometryLayerID)); } }
...
- SRP Batcher: Use the SRP Batcher to automatically batch multiple beams and reduce draw calls. Only available when using SRP.");
            ...
            public static string ErrorSrpAndMultiPassNotCompatible { get { return string.Format("Using a Scriptable Render Pipeline with 'Multi-Pass' Rendering Mode is not supported: please choose another Rendering Mode, or '{0}' will be used.", HDRPVLB.Config.Instance.actualRenderingMode); } }
            public static string ErrorSrpBatcherOnlyCompatibleWithSrp { get { return string.Format("The 'SRP Batcher' Rendering Mode is only compatible when using a SRP: please choose another Rendering Mode, or '{0}' will be used.", HDRPVLB.Config.Instance.actualRenderingMode); } }
            public static string ErrorSrpBatcherNotCompatibleWithLWRP { get { return string.Format("The 'SRP Batcher' Rendering Mode is not compatible with LWRP: please choose another Rendering Mode, or '{0}' will be used.", HDRPVLB.Config.Instance.actualRenderingMode); } }
            public static string ErrorGeometryGpuInstancingNotSupported { get { return string.Format("'GPU Instancing' Rendering Mode is only supported on Unity 5.6 or above! '{0}' will be used.", HDRPVLB.Config.Instance.actualRenderingMode); } }
