Shader "Hidden/HDRPVLB_URP_SinglePass"
{
    Properties
    {
    ...
    Category
    {
        ...
        SubShader
        {
            Pass
            {
                ...
                #pragma multi_compile_local __ HDRPVLB_ALPHA_AS_BLACK
                #pragma multi_compile_local __ HDRPVLB_NOISE_3D
                #pragma multi_compile_local __ HDRPVLB_DEPTH_BLEND
                #pragma multi_compile_local __ HDRPVLB_COLOR_GRADIENT_MATRIX_HIGH
                #pragma multi_compile_local __ HDRPVLB_OCCLUSION_CLIPPING_PLANE HDRPVLB_OCCLUSION_DEPTH_TEXTURE
                #pragma multi_compile_local __ HDRPVLB_MESH_SKEWING
                #pragma multi_compile_local __ HDRPVLB_SHADER_ACCURACY_HIGH


                #define HDRPVLB_PASS_OUTSIDEBEAM_FROM_VS_TO_FS 1
                #define HDRPVLB_SRP_API 1
                ...
                v2f vert(HDRPVLB_appdata v)         { return vertShared(v, v.texcoord.y); }
