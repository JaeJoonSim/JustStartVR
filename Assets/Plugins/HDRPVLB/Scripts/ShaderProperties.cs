...
namespace HDRPVLB
{
    public static class ShaderProperties
    {
        ...
        public static readonly int GlobalUsesReversedZBuffer    = Shader.PropertyToID("_HDRPVLB_UsesReversedZBuffer");
        public static readonly int GlobalNoiseTex3D             = Shader.PropertyToID("_HDRPVLB_NoiseTex3D");
        public static readonly int GlobalNoiseCustomTime        = Shader.PropertyToID("_HDRPVLB_NoiseCustomTime");
        public static readonly int GlobalDitheringFactor        = Shader.PropertyToID("_HDRPVLB_DitheringFactor");
        public static readonly int GlobalDitheringNoiseTex      = Shader.PropertyToID("_HDRPVLB_DitheringNoiseTex");
    }
}
