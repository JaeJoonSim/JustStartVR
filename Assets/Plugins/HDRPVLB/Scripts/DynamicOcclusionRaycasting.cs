...
namespace HDRPVLB
{
    ...
    public class DynamicOcclusionRaycasting : DynamicOcclusionAbstractBase
    {
        ...
        {
            Debug.Assert(collider, "You should pass a valid Collider to HDRPVLB.DynamicOcclusion.IsColliderHiddenByDynamicOccluder");
        ...
        protected override string GetShaderKeyword() { return "HDRPVLB_OCCLUSION_CLIPPING_PLANE"; }
