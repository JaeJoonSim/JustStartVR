...
#pragma warning restore 0414
        ...
        public void RefreshShader(RefreshShaderFlags flags)
        {
            ...
            {
                Debug.LogError("No dummy material referenced to HDRPVLB config, please try to reset this asset.", this);
            }
        ...
        public void ResetInternalData()
        {
            ...
            ditheringNoiseTexture = Resources.Load("HDRPVLBDitheringNoise", typeof(Texture2D)) as Texture2D;
