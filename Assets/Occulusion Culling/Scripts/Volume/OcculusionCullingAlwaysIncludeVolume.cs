...
{
    public class OcculusionCullingAlwaysIncludeVolume : MonoBehaviour, CustomHandle.IResizableByHandle
    { 
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Handles.color = new Color(0, 1, 0, OcculusionCullingConstants.VolumeInsideAlpha);
